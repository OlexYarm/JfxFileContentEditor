...
public class App extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        SCENE = new Scene(Utils.loadFXML("jfxFileContentEditor"), Settings.INT_WINDOW_WIDTH, Settings.INT_WINDOW_HIGH);
        ...
        stage.setOnCloseRequest(new EventHandler<WindowEvent>() {
            ...
            public void handle(WindowEvent event) {
                ...
                if (Utils.checkAnyoneFileModified(lstTabs)) {
        ...
        ExploreSceneGraph.exploreScene(0, "App", SCENE);
